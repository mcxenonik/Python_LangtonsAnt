...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.whiteImageRB.sizePolicy().hasHeightForWidth())
        self.whiteImageRB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.heightSB.sizePolicy().hasHeightForWidth())
        self.heightSB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.imageFromFileRB.sizePolicy().hasHeightForWidth())
        self.imageFromFileRB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.randomImageRB.sizePolicy().hasHeightForWidth())
        self.randomImageRB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.probabilitySB.sizePolicy().hasHeightForWidth())
        self.probabilitySB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.pathLE.sizePolicy().hasHeightForWidth())
        self.pathLE.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.generateImagePB.sizePolicy().hasHeightForWidth())
        self.generateImagePB.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.widthSB.sizePolicy().hasHeightForWidth())
        self.widthSB.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.allIterationsRB.sizePolicy().hasHeightForWidth())
        self.allIterationsRB.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.saveImageToFileCB.sizePolicy().hasHeightForWidth())
        self.saveImageToFileCB.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.saveItersSB.sizePolicy().hasHeightForWidth())
        self.saveItersSB.setSizePolicy(sizePolicy3)
        ...
        sizePolicy.setHeightForWidth(self.numOfItersSB.sizePolicy().hasHeightForWidth())
        self.numOfItersSB.setSizePolicy(sizePolicy)
