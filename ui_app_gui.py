...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.saveIterationsLE.setMaxLength(4)
        ...
        self.probabilityLE.setMaxLength(5)
        ...
        self.numOfIterLE = QLineEdit(self.groupBox_3)
        self.numOfIterLE.setObjectName(u"numOfIterLE")
        self.numOfIterLE.setGeometry(QRect(10, 40, 101, 20))
        self.numOfIterLE.setMaxLength(6)
